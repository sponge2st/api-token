...
def get_token(password, uid):
    url = "https://ffmconnect.ggwhitehawk.com/oauth/guest/token/grant"
    headers = {
...
def process_token(uid, password):
    ...
    game_data.timestamp = "2025-07-30 11:02:51"
    game_data.game_name = "free fire"
    game_data.game_version = 1
    game_data.version_code = "1.108.3"
    game_data.os_info = "Android OS 7.1.2 / API-23 (PI/rel.cjw.20220518.114133)"
